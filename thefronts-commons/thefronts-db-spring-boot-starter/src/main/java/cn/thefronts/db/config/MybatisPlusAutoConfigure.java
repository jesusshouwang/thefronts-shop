...
import cn.thefronts.db.interceptor.CustomTenantInterceptor;
import cn.thefronts.db.properties.MybatisPlusAutoFillProperties;
...
public class MybatisPlusAutoConfigure {
    ...
    @ConditionalOnProperty(prefix = "thefronts.mybatis-plus.auto-fill", name = "enabled", havingValue = "true", matchIfMissing = true)
