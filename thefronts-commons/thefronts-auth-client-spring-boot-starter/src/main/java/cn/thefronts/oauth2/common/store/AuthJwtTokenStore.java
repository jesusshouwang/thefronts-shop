...
import cn.thefronts.oauth2.common.converter.CustomUserAuthenticationConverter;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "thefronts.oauth2.token.store", name = "type", havingValue = "authJwt")
