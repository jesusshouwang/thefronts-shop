package cn.thefronts.file.service.impl;

import cn.thefronts.oss.model.ObjectInfo;
 ...
 */
@Service
@ConditionalOnProperty(prefix = cn.thefronts.oss.properties.FileServerProperties.PREFIX, name = "type", havingValue = FileServerProperties.TYPE_FDFS)
